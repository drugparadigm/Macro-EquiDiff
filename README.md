...
Macrocyclic compounds are important in drug discovery as they can modulate protein–protein interactions and enhance selectivity. Their structural complexity enables access to chemical space beyond traditional small molecules, but designing feasible macrocycles remains difficult. \n
Current computational methods often fail to generate macrocycles with proper drug-like properties. Here, we present Macro-Equi-Diff (MED), a deep learning framework combining transformer-based site identification, an E(3)-equivariant diffusion model (EDM) for linker creation, a fragment–linker attachment and pharmacokinetic validation module. MED transforms acyclic molecules into structurally consistent macrocycles. MED was tested on the ZINC dataset, achieving high validity (93.82%), uniqueness (99.94%), macrocyclization (99.94%), and linker novelty (65.66%). MED improves upon previous methods that lack macrocyclic geometry context. \n
