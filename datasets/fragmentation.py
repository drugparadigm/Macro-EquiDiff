            ...
            if pass_len and pass_ring:
                ...
                if len(anchor_indices) == 2:
                    records.append({
                        ...
                        "fragments": acyclic_with_dummy.replace("(*)","").replace("[*]","").replace("*",""),
                        "linker": linker.replace("(*)","").replace("[*]","").replace("*",""),
                    })
...
# Example usage:
process_macrocycles_csv("data/jm3c00134_si_002.csv", "macrocycle_table.csv")
