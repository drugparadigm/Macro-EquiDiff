...
def extract_linkers_from_sdf(sdf_file, output_txt):
    """
    Reads an SDF file and extracts linker SMILES into a text file.
    """
...
def main():
    ...
    augmented = generate_augmented_smiles(user_smiles, 2)
    ...
    extract_linkers_from_sdf("drug_sinter/linkers.sdf", "drug_sinter/linkers.txt")
